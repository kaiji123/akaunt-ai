        ...
        methods: {
            ...
            onSubmit(event) {
                ...
                console.log('Form submitting with data:', {
                    ...
                    user_password: this.form.user_password ? '***' : 'empty'
                });

                this.form.loading = true;

                // Use axios directly instead of form.submit()
                axios.post('/install/settings', {
                    company_name: this.form.company_name,
                    company_email: this.form.company_email,
                    user_email: this.form.user_email,
                ...
                .then(response => {
                    ...
                    if (response.data.redirect) {
                        console.log('Will redirect to:', response.data.redirect);
                ...
                .catch(error => {
                    console.error('ERROR - Installation error:', error);
